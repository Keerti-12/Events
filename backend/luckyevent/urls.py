...
# Serve media files (always enabled for image uploads)
# Note: On Render, filesystem is ephemeral - files will be lost on redeploy
# Use Cloudinary or S3 for persistent storage in production
